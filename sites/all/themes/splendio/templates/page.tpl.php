...
<div id="wrapper">
  <div id="header">
   ...
   <div class="syndicate">
    ...
    <li><a class="s4" title="Contact Mail" href="mailto:wzs.hoboken@hotmail.com?Subject=contact_website" <?php echo theme_get_setting('contact_link'); ?>" target="_blank" rel="me"><em>Contact</em></a></li>
