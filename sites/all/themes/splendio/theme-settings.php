...
function splendio_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['splendio_settings']['social_icons'] = array(
    '#type' => 'checkbox',
    '#title' => t('Show contact icon in header'),
    '#default_value' => theme_get_setting('social_icons'),
    '#description'   => t("Check this option to show contact icon in header. Uncheck to hide."),
  );
  ...
  $form['splendio_settings']['contact_link'] = array(
    '#type' => 'textfield',
    '#title' => t('contact_link'),
    '#default_value' => theme_get_setting('contact_link'),
	'#description'   => t("Enter your contact email adres."),
  );
